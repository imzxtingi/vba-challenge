A lot of the code written in here was modeled after the VBA class activity on credit card checkers and also the class activity gradebook conditionals to find the code for text formatting.
